      ...
      <div className="mx-5">
        ...
        <div className="space-y-4 text-justify indent-5 mb-8">
          <p>
            ...
            kebutuhan dan preferensi pribadi, menciptakan lingkungan kerja yang
            sangat ideal untuk pengembangan perangkat lunak.
          </p>
          <p>
            Dengan <span className="text-sky-500 font-bold">Arch Linux </span>
            yang disesuaikan khusus, setiap hari saya merasa lebih produktif dan
            terinspirasi. Sistem operasi ini menawarkan cara kerja yang efisien
            dan memuaskan. Jika Anda mencari platform yang sepenuhnya dapat
            disesuaikan dan menawarkan performa optimal,
            <span className="text-sky-500 font-bold"> Arch Linux </span> adalah
