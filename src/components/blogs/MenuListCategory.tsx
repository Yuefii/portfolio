  ...
  return (
    <div className="mt-5">
      ...
      <ul className="mt-3 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-2 gap-3">
        <li className="bg-rose-600 py-1.5 px-3 rounded-md text-sm flex items-center">
          <Link href="">Backend</Link>
        </li>
        <li className="bg-sky-600 py-1.5 px-3 rounded-md text-sm flex items-center">
          <Link href="">Frontend</Link>
        </li>
        <li className="bg-amber-600 py-1.5 px-3 rounded-md text-sm flex items-center">
